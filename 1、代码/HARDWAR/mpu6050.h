...
#define RCC_APB2Periph_GPIO_MPU RCC_APB2Periph_GPIOB
#define GPIO_Pin_MPU_SCL 				GPIO_Pin_5
#define	GPIO_Pin_MPU_SDA 				GPIO_Pin_6
#define GPIO_MPU		 						GPIOB

//IO操作函数	 
#define MPU_IIC_SCL    PBout(5) 		//SCL
